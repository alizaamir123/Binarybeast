...
export default function Sofas() {
  ...
  const filteredSofas = sofas
    ...
    .filter((sofa) => {
      ...
      if (priceFilter === "under400") return price < 400;
      if (priceFilter === "400to600") return price >= 400 && price <= 600;
      if (priceFilter === "above600") return price > 600;
      return true;
    })
    .sort((a, b) => {
  ...
  return (
    <div className="bg-[#faf9f7]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col md:flex-row gap-4 justify-between items-center">
        <input
          type="text"
          placeholder="Search shower or bathtub..."
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        {filteredSofas.length === 0 ? (
          <p className="text-center text-gray-500 text-lg">
            No shower or bathtub matches your search or filter.
          </p>
        ) : (
          <>
