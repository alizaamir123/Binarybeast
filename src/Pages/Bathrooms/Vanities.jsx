...
const sofas = [
  {
    name: "Modern",
    price: "$280",
    img: "/assets/images/vanities and cabnites1.jpg",
  },
  {
    name: "Classic",
    price: "$220",
    img: "/assets/images/vanities and cabnites2.jpg",
  },
  {
    name: "Minimalist",
    price: "$350",
    img: "/assets/images/vanities and cabnites3.jpg",
  },
  {
    name: "Luxury",
    price: "$500",
    img: "/assets/images/vanities and cabnites4.jpg",
  },
];
...
export default function Sofas() {
  ...
  const filteredSofas = sofas
    ...
    .filter((sofa) => {
      ...
      if (priceFilter === "under250") return price < 250;
      if (priceFilter === "250to400") return price >= 250 && price <= 400;
  ...
  return (
    <div className="bg-[#faf9f7]">
      ...
      <div className="relative h-[500px] flex items-center justify-center text-center">
        <img
          src="/assets/images/vanities and cabnitesbanner.jpg"
          alt="Vanities and Cabinets Banner"
          className="absolute inset-0 w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-black/50"></div>
        <h1 className="relative text-white text-4xl md:text-5xl font-bold drop-shadow-lg">
          Elegant Vanities and Cabinets Collection
        </h1>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        {filteredSofas.length === 0 ? (
          <p className="text-center text-gray-500 text-lg">
            No vanities or cabinets match your search or filter.
          </p>
        ) : (
          <>
            <h2 className="text-3xl font-semibold text-gray-800 mb-8 text-center">
              Discover Our Vanities and Cabinets
            </h2>
