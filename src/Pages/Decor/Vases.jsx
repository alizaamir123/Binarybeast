...
const sofas = [
  { name: "Modern", price: "$1,200", img: "/assets/images/vases and plant pots1.jpg" },
  { name: "Classic", price: "$980", img: "/assets/images/vases and plant pots2.jpg" },
  { name: "Minimalist", price: "$1,050", img: "/assets/images/vases and plant pots3.jpg" },
  { name: "Luxury", price: "$1,500", img: "/assets/images/vases and plant pots4.jpg" },
];
  ...
  return (
    <div className="bg-[#faf9f7]">
      ...
      <div className="relative h-[500px] flex items-center justify-center text-center">
        <img
          src="/assets/images/vases and plant potsbanner.jpg"
          alt="Vases and Plant Pots Banner"
          className="absolute inset-0 w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-black/50"></div>
        <h1 className="relative text-white text-4xl md:text-5xl font-bold drop-shadow-lg">
          Elegant Vases and Plant Pots Collection
        </h1>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        {filteredSofas.length === 0 ? (
          <p className="text-center text-gray-500">No vases or plant pots found</p>
        ) : (
