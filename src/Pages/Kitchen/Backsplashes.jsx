...
const sofas = [
  { name: "Modern", price: "$1,200", img: "/assets/images/back4.jpg" },
  { name: "Classic", price: "$980", img: "/assets/images/back3.jpg" },
  { name: "Minimalist", price: "$1,050", img: "/assets/images/back1.jpg" },
  { name: "Luxury", price: "$1,500", img: "/assets/images/back2.jpg" },
];
    ...
    <div className="bg-[#faf9f7]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        {filteredSofas.length === 0 ? (
          <p className="text-center text-gray-500">No backsplashes found</p>
        ) : (
