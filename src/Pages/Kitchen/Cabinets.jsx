...
const sofas = [
  { name: "Modern", price: "$1,200", img: "/assets/images/cabnites.jpg" },
  { name: "Classic", price: "$980", img: "/assets/images/cabnites1.jpg" },
  { name: "Minimalist", price: "$1,050", img: "/assets/images/cabnites2.jpg" },
  { name: "Luxury", price: "$1,500", img: "/assets/images/cabnites3.jpg" },
];
    ...
    <div className="bg-[#faf9f7]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        {filteredSofas.length === 0 ? (
          <p className="text-center text-gray-500">No cabinets found</p>
        ) : (
