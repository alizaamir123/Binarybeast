...
const lights = [
  { name: "Modern", price: "$1,200", img: "/assets/images/lighting2.jpg" },
  { name: "Classic", price: "$980", img: "/assets/images/lighting11.jpg" },
  { name: "Minimalist", price: "$1,050", img: "/assets/images/lighting.jpg" },
  { name: "Luxury", price: "$1,500", img: "/assets/images/lighting4.jpg" },
];
    ...
    <div className="bg-[#faf9f7]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        {filteredLights.length === 0 ? (
          <p className="text-center text-gray-500">No lights found</p>
        ) : (
