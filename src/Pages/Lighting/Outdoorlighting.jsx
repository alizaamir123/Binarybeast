...
const outdoorLights = [
  { name: "Modern", price: "$1,200", img: "/assets/images/outdoor lighting1.jpg" },
  { name: "Classic", price: "$980", img: "/assets/images/outdoor lighting.jpg" },
  { name: "Minimalist", price: "$1,050", img: "/assets/images/outdoor lighting2.jpg" },
  { name: "Luxury", price: "$1,500", img: "/assets/images/outdoor lighting3.jpg" },
];
...
export default function OutdoorLighting() {
  ...
  const filteredLights = outdoorLights
  ...
  return (
    <div className="bg-[#faf9f7]">
      ...
      <div className="relative h-[500px] flex items-center justify-center text-center">
        <img
          src="/assets/images/outdoor lightingbanner.jpg"
          alt="Outdoor Lighting Banner"
          className="absolute inset-0 w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-black/50"></div>
        <h1 className="relative text-white text-4xl md:text-5xl font-bold drop-shadow-lg">
          Elegant Outdoor Lighting Collection
        </h1>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        {filteredLights.length === 0 ? (
          <p className="text-center text-gray-500">No outdoor lights found</p>
        ) : (
