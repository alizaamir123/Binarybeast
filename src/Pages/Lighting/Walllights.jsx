...
const wallLights = [
  { name: "Modern", price: "$1,200", img: "/assets/images/walllight.jpg" },
  { name: "Classic", price: "$980", img: "/assets/images/walllight2.jpg" },
  { name: "Minimalist", price: "$1,050", img: "/assets/images/walllight3.jpg" },
  { name: "Luxury", price: "$1,500", img: "/assets/images/walllight1.jpg" },
];

export default function WallLights() {
  ...
  const filteredLights = wallLights
    ...
    <div className="bg-[#faf9f7]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        {filteredLights.length === 0 ? (
          <p className="text-center text-gray-500">No wall lights found</p>
        ) : (
            ...
            {filteredLights.map((light, index) => (
              ...
              >
                ...
                <div className="p-5 text-center">
                  <h3 className="text-lg font-semibold text-gray-900">{light.name}</h3>
                  <p className="text-gray-600 mt-2">{light.price}</p>
                  <button className="mt-4 px-5 py-2 bg-[#0f172a] text-white rounded-lg hover:bg-[#1e293b] transition-colors">
                    Interior Design Wall Light
                  </button>
                </div>
              </div>
            ))}
